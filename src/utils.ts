...
hljs.registerLanguage('c', require('highlight.js/lib/languages/c.js'))
// hljs.registerLanguage('clean', require('highlight.js/lib/languages/clean.js'))
// hljs.registerLanguage('c-like', require('highlight.js/lib/languages/c-like.js'))
...
// hljs.registerLanguage('nim', require('highlight.js/lib/languages/nim.js'))
// hljs.registerLanguage('nix', require('highlight.js/lib/languages/nix.js'))
// hljs.registerLanguage('node-repl', require('highlight.js/lib/languages/node-repl.js'))
...
// hljs.registerLanguage('php-template', require('highlight.js/lib/languages/php-template.js'))
...
// hljs.registerLanguage('python-repl', require('highlight.js/lib/languages/python-repl.js'))
...
export const formatCode = (code: any, lang: any) =>
